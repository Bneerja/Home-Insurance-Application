...
<title>MyPolicies</title>

<h1 style="text-align: center; font-size: 58px;">
			<img alt="" height="40px" width="40px" src="./images/house.jpg">Homeowner
			Insurance	</h1>
<body>
<form action="MyPoliciesServlet" method ="post">
<%List<PolicyDetails> mylist = (List)session.getAttribute("mypolicy");%>						
		...
		<hr>
		<h3 style="text-align: center;">Policy Confirmation</h3>
